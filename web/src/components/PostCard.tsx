                    ...
                    {isPending ? (
                        ...
                        <div className="relative w-full h-full group">
                            <video
                                ...
                                onError={(e) => {
                                    console.error('[PostCard] Video failed to load:', displayUrl, e);
                                    setImageError(true);
                                }}
                            />
                            <button
                                ...
                                className="absolute bottom-3 right-3 p-2 bg-black/50 hover:bg-black/70 rounded-full text-white/80 hover:text-white transition-all opacity-0 group-hover:opacity-100"
                            >
                                {isMuted ? (
